...
export default function DesktopMock({ isActive = true }: { isActive?: boolean }) {
  ...
  return (
    <div style={{ padding: 40, display: "flex", justifyContent: "center", alignItems: "center", minHeight: "70vh", background: "#f8fafc" }}>
      <div style={{ width: monitorWidth, maxWidth: "96%", display: "flex", flexDirection: "column", alignItems: "center" }}>
